...
/*
Problem Statement:
Implement a University Management System that demonstrates multilevel inheritance
and hierarchical relationships between different types of university members.

Requirements:
1. Create a base Person class with common attributes (name, age, address)
2. Implement Staff class extending Person with additional staff-specific details
3. Create Professor class extending Staff with teaching capabilities
4. Implement Student class extending Person with student-specific attributes
5. Demonstrate proper constructor chaining and method overriding

Key Concepts Demonstrated:
- Multilevel Inheritance (Person -> Staff -> Professor)
- Hierarchical Inheritance (Person -> Student)
- Method Overriding
