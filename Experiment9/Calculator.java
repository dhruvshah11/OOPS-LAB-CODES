...
/**
 * Question: GUI Calculator with Java Swing
 *
 * Create a graphical calculator application using Java Swing components.
 * The program should demonstrate GUI development, event handling, and
 * basic arithmetic operations in a user-friendly interface.
 *
 * Requirements:
 * 1. Implement a calculator with:
 *    - Numeric keypad (0-9)
 *    - Basic operations (+, -, *, /)
