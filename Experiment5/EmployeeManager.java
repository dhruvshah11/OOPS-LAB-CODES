...
/*
Problem Statement:
Create a Java program to demonstrate inheritance and method overriding using an Employee-Manager hierarchy.
Implement the following requirements:
1. Create a base Employee class with attributes for name, employee ID, and salary
2. Include methods for getting employee details and increasing salary
3. Create a Manager class that inherits from Employee and adds a department attribute
4. Override the salary increase method for Manager to include a bonus
5. Demonstrate the functionality with a test program
